    ...
    <div className={`min-h-screen bg-[#F8FAFC] text-slate-800 font-['Tajawal',sans-serif] ${lang === 'AR' ? 'dir-rtl' : 'dir-ltr'} antialiased selection:bg-indigo-600 selection:text-white`}>
        ...
        <div className="max-w-[1400px] mx-auto flex items-center justify-between gap-4 md:gap-8">
          ...
          <div className="flex items-center gap-2.5 shrink-0">
            ...
            {currentMember?.role === 'admin' ? (
              ...
              <button
                onClick={() => onNavigate('MERCHANT_DASHBOARD')}
      ...
      <section id="suppliers" className="max-w-[1400px] mx-auto px-4 lg:px-8 py-8 space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-200 pb-4">
          ...
          <button
            onClick={currentMember?.role === 'merchant' ? () => onNavigate('MERCHANT_DASHBOARD') : onOpenLoginModal}
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="space-y-2">
              ...
              <ul className="space-y-1.5 text-slate-400">
                ...
                <li><button onClick={currentMember?.role === 'merchant' ? () => onNavigate('MERCHANT_DASHBOARD') : onOpenLoginModal} className="hover:text-amber-400 transition font-bold">{currentMember?.role === 'merchant' ? 'لوحة تحكم متجرك 🏪' : 'لوحة تحكم التجّار'}</button></li>
              </ul>
            </div>
