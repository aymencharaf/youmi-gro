...
export const PlatformLanding: React.FC<PlatformLandingProps> = ({
  ...
  onSelectStore = (
    _store: Store,
    _view: 'MERCHANT_DASHBOARD' | 'STORE_FRONT'
  ) => {},
  onOpenLoginModal = () => {},
  isLoggedIn = false,
  ...
  const [platformAnnouncements, setPlatformAnnouncements] =
    useState<PlatformAnnouncement[]>(() =>
      getPlatformAnnouncements().filter(
        (a) =>
          a.active &&
          (a.targetAudience === 'all' || a.targetAudience === 'buyers')
      )
    );
  ...
  React.useEffect(() => {
    ...
    return () =>
      window.removeEventListener('youmi_settings_updated', handleUpdate);
  }, []);
  ...
  const heroSlides = [
    {
      ...
      subtitle:
        'ربط مباشر بين كبار المستوردين والمصانع مع تجار التجزئة. أطلب كميات الجملة بأفضل الأسعار مع الشحن لـ 69 ولاية.',
    ...
    },
    {
      ...
      subtitle:
        'تغطية كاملة لكافة ولايات الجزائر عبر التوصيل للمنزل أو المكتب (Yalidine Express API). لا حاجة للدفع المسبق!',
    ...
    },
    {
      ...
      subtitle:
        'لوحة تحكم متكاملة، ربط شركات الشحن الفوري، إدارة فواتير الجملة وتتبع المبيعات عبر بريدي موب وبدون عمولات.',
  ...
  const wholesaleCategories = [
    {
      ...
      nameFr: 'Quincaillerie & Matériaux',
      count: '180+ مورد',
      color:
    ...
    },
    {
      ...
      nameFr: 'Ustensiles & Arts de Table',
      count: '130+ مورد',
      color:
    ...
    {
      icon: Box,
      nameAr: 'أثاث ومفروشات وديكور',
      nameFr: 'Meubles & Ameublement',
      count: '90+ مورد',
      color:
    ...
    },
    {
      ...
      nameFr: 'Pièces Auto & Accessoires',
      count: '110+ مورد',
      color:
    ...
    {
      icon: Utensils,
      nameAr: 'مواد غذائية وسوبرماركت',
      nameFr: 'Agroalimentaire & Épicerie',
      count: '210+ مورد',
      color:
    ...
    {
      icon: ShieldCheck,
      nameAr: 'مستلزمات ومواد طبية',
      nameFr: 'Matériel Médical & Pharma',
      count: '75+ مورد',
      color:
    ...
    {
      icon: Gift,
      nameAr: 'ألعاب وهدايا ومكتبية',
      nameFr: 'Jouets, Cadeaux & Papeterie',
      count: '85+ مورد',
      color:
  ...
  const handleAddToCart = (
    ...
    const minQty =
      qtyToAdd || product.minOrderQuantity || 1;
  ...
  const totalCartPriceDzd = cartItems.reduce(
    (acc, item) =>
  ...
  return (
    <div
      className={`min-h-screen bg-[#F8FAFC] text-slate-800 font-['Tajawal',sans-serif] ${
        lang === 'AR' ? 'dir-rtl' : 'dir-ltr'
      } antialiased selection:bg-indigo-600 selection:text-white`}
    >
          ...
          <div className="flex items-center gap-2 text-center sm:text-right overflow-hidden">
            ...
            <span className="text-slate-200 font-bold truncate max-w-xl">
              ...
              {platformAnnouncements[0] ? (
                <span>
                  <strong>
                    {platformAnnouncements[0].title}:
                  </strong>{' '}
                  {platformAnnouncements[0].content}
                </span>
              ) : (
                <span>
                  🇩🇿 المنصة الجزائرية الأولى لتجارة الجملة والربط
                  المباشر بين المصنعين والموردين وتجار التجزئة.
                </span>
              )}
        ...
        <div className="max-w-[1400px] mx-auto flex items-center justify-between gap-4 md:gap-8">
          ...
          <div className="flex-1 max-w-2xl hidden md:flex items-center bg-slate-50 border border-slate-300 rounded-2xl overflow-hidden focus-within:border-indigo-600 focus-within:bg-white focus-within:ring-2 focus-within:ring-indigo-500/15 transition shadow-xs">
            ...
            >
              ...
              <option value="هواتف وإلكترونيات">
                هواتف وإلكترونيات
              </option>

              <option value="أزياء وقماش بالجملة">
                أزياء وقماش بالجملة
              </option>

              <option value="عطور ومواد التجميل">
                عطور ومواد التجميل
              </option>

              <option value="أجهزة كهرومنزلي">
                أجهزة كهرومنزلي
              </option>

              <option value="أدوات ومعدات البناء">
                أدوات ومعدات البناء
              </option>

              <option value="مواد غذائية وحلويات">
                مواد غذائية وحلويات
              </option>
            </select>
            ...
            <button
              ...
              className="bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-2.5 text-xs font-bold transition flex items-center gap-1.5 shrink-0"
            >
      ...
      <section className="max-w-[1400px] mx-auto px-4 lg:px-8 py-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
          ...
          <div className="lg:col-span-8 bg-slate-950 rounded-3xl overflow-hidden shadow-xl border border-slate-800 relative min-h-[380px] flex flex-col justify-between p-6 md:p-10 text-white">
            ...
            <div
              className={`absolute inset-0 bg-gradient-to-r ${heroSlides[activeHeroSlide].bgGradient} opacity-90`}
            />
          ...
          <div className="lg:col-span-4 flex flex-col justify-between gap-4">
            ...
            <div className="p-6 bg-gradient-to-br from-indigo-900 via-indigo-950 to-slate-900 text-white rounded-3xl border border-indigo-800 shadow-md flex-1 flex flex-col justify-between space-y-4 relative overflow-hidden">
              ...
              <div className="space-y-2 relative z-10">
                ...
                <div className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-amber-400/20 border border-amber-400/30 text-amber-300 text-[11px] font-bold rounded-lg">
                  ...
                  <span>
                    تجار ومستوردو الجملة
                  </span>

                </div>

                <h3 className="text-lg font-black font-['Cairo']">
                  هل تملك سلعة أو مصنع بالجملة؟
                </h3>
              ...
              >
                ...
                <span>
                  أنشئ متجرك (تجربة 30 يوماً مجاناً)
                </span>
              </button>
            ...
            <div className="p-5 bg-white border border-slate-200 rounded-3xl shadow-sm space-y-3">
              ...
              <h4 className="text-xs font-bold text-slate-800 font-['Cairo'] flex items-center gap-1.5">
                ...
                <span>
                  إحصائيات منصة يومي بالجملة (2026)
                </span>
              ...
              <div className="grid grid-cols-3 gap-2 text-center text-xs">
                ...
                <div className="p-2.5 bg-slate-50 rounded-2xl border border-slate-100">
                  <p className="font-extrabold text-indigo-600 text-sm font-mono">
                    +1,200
                  </p>
      ...
      <section
        id="suppliers"
        className="max-w-[1400px] mx-auto px-4 lg:px-8 py-8 space-y-6"
      >
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-200 pb-4">
          ...
          >
            <span>
              {currentMember?.role ===
              'merchant'
                ? 'الذهاب إلى لوحة تحكم متجرك 🏪 ←'
                : 'دخول لوحة تحكم التاجر ←'}
            </span>
          </button>
              ...
              <div className="space-y-3">
                ...
                <div className="pt-2 border-t border-slate-100 grid grid-cols-2 gap-2 text-[11px]">
                  ...
                  <div className="p-2 bg-slate-50 rounded-xl border border-slate-100 flex items-center gap-1.5 text-slate-700">
                    ...
                    <span className="truncate font-semibold">
                      أدنى حد:{' '}
                      {s.settings?.minWholesaleCartTotal
                        ? `${s.settings.minWholesaleCartTotal.toLocaleString()} دج`
                        : '10,000 دج'}
                    </span>
          ...
          {filteredWholesaleProducts.length === 0 ? (
            ...
            <div className="py-12 text-center space-y-3">
              ...
              <p className="text-xs font-bold text-slate-600">
                لا توجد منتجات جملة مطابقة للبحث حالياً
              </p>
                          ...
                          <div>
                            ...
                            {canViewWholesalePrices ? (
                              ...
                              <button
                                ...
                                className="text-xs font-bold text-indigo-600 hover:text-indigo-800 transition text-right"
                              >
                                تسجيل الدخول لرؤية سعر الجملة
                              </button>
              ...
              {cartItems.length === 0 ? (
                ...
                <div className="py-16 text-center space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs font-bold text-slate-600">
                      سلّة طلبات الجملة فارغة حالياً
                    </p>

                    <p className="text-[11px] text-slate-400 mt-1">
                      تصفح المتاجر والمنتجات وأضف كميات الجملة للطلب
                    </p>
              ...
              {cartItems.length > 0 && (
                ...
                <>
                  ...
                  <div className="p-3 bg-emerald-50 rounded-xl border border-emerald-200 text-[11px] text-emerald-900 flex items-center gap-1.5">
                    ...
                    <span>
                      طريقة السداد: الدفع نقداً عند استلام شحنة الجملة (COD)
                    </span>
                  ...
                  >
                    <span>
                      متابعة إتمام الطلب بالمتجر المختص
                    </span>
        ...
        <div className="max-w-[1400px] mx-auto space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="space-y-2">
              ...
              <ul className="space-y-1.5 text-slate-400">
                ...
                <li>
                  ...
                  >
                    أنشئ متجر جملة (30 يوماً مجاناً)
                  </button>
                </li>
                ...
                <li>
                  <button
                    ...
                    className="hover:text-amber-400 transition font-bold"
                  >
                    {currentMember?.role ===
                    'merchant'
                      ? 'لوحة تحكم متجرك 🏪'
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-slate-400">
                فريق خدمة العملاء متواجد لمساعدتك في إنشاء وافتتاح متجرك بالجملة.
              </p>
          ...
          <div className="pt-6 border-t border-slate-900 flex flex-col sm:flex-row items-center justify-between gap-4 text-slate-500 text-[11px]">
            ...
            <p>
              جميع الحقوق محفوظة © 2026 لمنصة يومي لتجارة الجملة بالجزائر (Youmi Market DZ)
            </p>
