    ...
    <div className={`min-h-screen bg-[#F8FAFC] text-slate-800 font-['Tajawal',sans-serif] ${lang === 'AR' ? 'dir-rtl' : 'dir-ltr'} antialiased selection:bg-indigo-600 selection:text-white`}>
      ...
      <footer className="bg-slate-950 text-slate-400 text-xs py-10 px-4 lg:px-8 border-t border-slate-800 mt-12">
        <div className="max-w-[1400px] mx-auto space-y-8">
          ...
          <div className="pt-6 border-t border-slate-900 flex flex-col sm:flex-row items-center justify-between gap-4 text-slate-500 text-[11px]"><p>جميع الحقوق محفوظة © 2026 لمنصة يومي لتجارة الجملة بالجزائر (Youmi Market DZ)</p><div className="flex items-center gap-4"><span>🇩🇿 تغطية كاملة لـ 69 ولاية</span><span>•</span><span>100% دفع عند الاستلام</span></div><button type="button" onClick={onOpenAdminLoginModal} aria-label="إدارة المنصة" title="إدارة المنصة" className="text-[9px] text-slate-700/40 hover:text-slate-400 transition px-1 py-0.5">إدارة</button></div>
        </div>
      </footer>
    </div>
  );
