...
export const api = {
  ...
  merchantOrders:(storeId:string)=>post('merchant_orders',{storeId}), updateOrder:(storeId:string,orderId:string,status:string,extra:any={})=>post('merchant_update_order',{storeId,orderId,status,...extra}),
